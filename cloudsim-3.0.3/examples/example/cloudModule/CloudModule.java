...
public class CloudModule {
    ...
    public  void searchBestTypeAmazon(int i,int j,double time,long k){
        FileReader fis = null;
        try {
            fis = new FileReader("/home/bikash/repos/NashBargaining/cloudsim-3.0.3/price/amazon.xml");
            XStream xStream = new XStream(new DomDriver());
            xStream.alias("Instance", Instance.class); //creating an alias
            xStream.alias("Type",Type.class);
    ...
    public  void searchBestTypeGoogle(int i,int j,double time, long k){
        FileReader fis = null;
        try {
            fis = new FileReader("/home/bikash/repos/NashBargaining/cloudsim-3.0.3/price/google.xml");
            XStream xStream = new XStream(new DomDriver());
            xStream.alias("Instance", Instance.class); //creating an alias
            xStream.alias("Type",Type.class);
    ...
    public  void searchBestTypeAzure(int i,int j,double time,long k){
        FileReader fis = null;
        try {
            fis = new FileReader("/home/bikash/repos/NashBargaining/cloudsim-3.0.3/price/azure.xml");
            XStream xStream = new XStream(new DomDriver());
            xStream.alias("Instance", Instance.class); //creating an alias
            xStream.alias("Type",Type.class);
