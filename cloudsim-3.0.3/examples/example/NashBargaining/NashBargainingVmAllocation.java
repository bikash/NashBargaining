...
import examples.RoundRobin.CircularHostList;

/**
 * Nash Bargaining {@link Vm} allocation policy.
 * 
 * @author Bikash
 */
public class NashBargainingVmAllocation extends org.cloudbus.cloudsim.VmAllocationPolicy {
  
	private final Map<String, Host> vm_table = new HashMap<String, Host>();
	
	private final CircularHostList hosts;
	
	public NashBargainingVmAllocation(List<? extends Host> list) {
		super(list);
